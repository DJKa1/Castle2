...
public class MouseInput implements MouseListener, MouseMotionListener, MouseWheelListener {
    ...
    public void mouseClicked(MouseEvent mouseEvent) {
        if (mouseEvent.getButton() == MouseEvent.BUTTON1 && game.getactiveState().getClass() == MenuState.class) {
            ...
            game.menu[game.getMenustate().menuindex].onMouseClick(mouseEvent.getX(), mouseEvent.getY());
    ...
    public void mouseMoved(MouseEvent mouseEvent) {
        ...
        if (game.getactiveState().getClass() == GameState.class) {
            ...
            game.menu[game.getMenustate().menuindex].onMouseHover(mouseEvent.getX(), mouseEvent.getY());
